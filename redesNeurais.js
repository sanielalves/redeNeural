...
function redesNeurais2() {

    var entradas = {teste: prompt("Quantas entradas o neurônio deve receber?")};
    document.getElementById("entradas").innerHTML = "Quantidade de entradas: " + entradas.teste;
